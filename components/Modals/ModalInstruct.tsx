...
const ModalInstruct = ({ show }: { show: boolean }) => {
  return (
    <ModalMain style={{ zIndex: show ? 100 : -1, display: show ? 'flex' : 'none' }}>
      ...
      <p>
        4. Если бот перестает работать нажать на кнопку в OBS "Обновить кэш текущей страницы" (команда !fakecache), либо
        сообщить разработчику в ВК -{' '}
        <a
      ...
      <p>
        !fakecache - обновление кэша в сцене (только для стримера, можно сделать бинд для стрим дека, чтобы не заходить
        в сцену)
      </p>
      <br />
      <p>
